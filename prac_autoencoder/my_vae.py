...
class AutoEncoder():
    ...
    def __init__(self):
        ...
        self.batch_size = self.config['vae']['batch_size']
        self.original_dim = self.config['vae']['original_dim']
        self.latent_dim = self.config['vae']['latent_dim']
        self.intermediate_dim = self.config['vae']['intermediate_dim']
        self.epochs = self.config['vae']['epochs']
        self.epsilon_std = self.config['vae']['epsilon_std']
        self.save_dir = self.config['vae']['save_dir']
